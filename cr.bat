...
set cflags= -O2 -fno-stack-protector -fomit-frame-pointer -fno-exceptions -fno-unwind-tables -fno-ident -Wno-return-type -Wno-pointer-sign -nostartfiles -D WINDOWS -I ./runtime
rem -fno-asynchronous-unwind-tables -e run
set rtw=./runtime/w/
